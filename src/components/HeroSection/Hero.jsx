  ...
  return (
    <div className="hero-comp">
      ...
      <div className="hero-content">
        ...
        <h1 className="hero-title">Transform your  <span className="extra-letters">space</span></h1>
        ...
        <div className="btns">
          ...
          <button className="btn-1">
            Start Project<img src={ButtonArrow} width={24} height={24} alt="button-arrow" />
          </button>
          </div>
         <div className="btn">
         <button className="btn-2">
            Learn More <img src={ButtonArrowBlack} width={24} height={24} alt="button-arrow" />
          </button>
          </div>
         </div>
         </div>
